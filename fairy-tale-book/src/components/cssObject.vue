  ...
  <div id="cssObjects">
    ...
    <div id="making_story_title">
      ...
      <div id="making_story_title_steps">
        <div id="making_story_title_step1" class="making_story_title_step">
          1. 이야기 생성
        </div>
        <div class="making_story_title_step">-></div>
        <div id="making_story_title_step2" class="making_story_title_step">
          2. 그림 생성
        </div>
        <div class="making_story_title_step">-></div>
        <div id="making_story_title_step3" class="making_story_title_step">
          3. pdf 생성
        </div>
      </div>
      <div>
